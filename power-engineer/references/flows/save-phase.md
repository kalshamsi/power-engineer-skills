...
AskUserQuestion:
  ...
  options:
    ...
    - label: "Phase 4"
      description: "Fourth implementation phase"
    - label: "Phase 5"
      description: "Fifth implementation phase"
    - label: "Phase 6"
      description: "Sixth implementation phase"
    - label: "Phase 7"
      description: "Seventh implementation phase"
    - label: "Phase 8"
      description: "Eighth implementation phase"
    - label: "Phase 9"
      description: "Final / release phase"
    - label: "Other"
      description: "Non-numeric phase (e.g., released, hotfix, spike). Type a short label in the free-text field."
```
