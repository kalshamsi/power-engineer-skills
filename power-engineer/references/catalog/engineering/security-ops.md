...
|-------|---------|-------------|
| incident-commander | `/plugin install engineering-advanced-skills@claude-code-skills` | Incident response workflows: severity classification, communication templates, escalation procedures, post-mortem generation. |
| env-secrets-manager | `/plugin install engineering-advanced-skills@claude-code-skills` | Secrets rotation, vault integration, .env management, security configuration across environments. |
