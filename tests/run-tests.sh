...
check "Hook uses correct nested format" "grep -q '\"type\": \"command\"' power-engineer/references/modules/configurator.md"
check "Hook does NOT use flat command format" "! grep -A1 '\"matcher\": \"compact\"' power-engineer/references/modules/configurator.md | grep -q '\"command\":'"
